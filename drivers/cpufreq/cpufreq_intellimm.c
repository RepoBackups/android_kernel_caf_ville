...
#else
#define DEF_POWER_SAVE_FREQUENCY		(648000)
#define DEF_TWO_PHASE_FREQUENCY			(1296000)
#define DBS_INPUT_EVENT_MIN_FREQ		(1134000)
#define DEF_FREQUENCY_OPTIMAL			(702000)
#define DEF_FREQ_DOWN_STEP			(270000)
...
int input_event_boosted_fce(void)
{
	unsigned long flags;
