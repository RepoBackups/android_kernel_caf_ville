...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L1,	 1, 1, 0,  800000,  800000, "8921_s4", 0, 10000),
	RPM_LDO(L2,	 0, 1, 0, 1200000, 1200000, "8921_s4", 0, 0),
	RPM_LDO(L3,	 0, 1, 0, 3075000, 3075000, NULL,      0, 0),
	RPM_LDO(L4,	 1, 1, 0, 1800000, 1800000, NULL,      10000, 10000),
	RPM_LDO(L5,	 0, 1, 0, 2950000, 2950000, NULL,      0, 0),
	RPM_LDO(L6,	 0, 1, 0, 2400000, 2500000, NULL,      0, 0),
	RPM_LDO(L7,	 1, 1, 0, 1850000, 2800000, NULL,      10000, 10000),
	RPM_LDO(L8,	 0, 1, 0, 2800000, 2800000, NULL,      0, 0),
	RPM_LDO(L9,	 0, 1, 0, 2800000, 2800000, NULL,      0, 0),
	RPM_LDO(L10,	 0, 1, 0, 2900000, 2900000, NULL,      0, 0),
	RPM_LDO(L11,	 0, 1, 0, 2800000, 3000000, NULL,      0, 0), 
	RPM_LDO(L12,	 0, 1, 0, 1000000, 1200000, "8921_s4", 0, 0), 
	RPM_LDO(L14,	 0, 1, 0, 1800000, 1800000, NULL,      0, 0),
	RPM_LDO(L15,	 0, 1, 0, 1800000, 2800000, NULL,      0, 0),
	RPM_LDO(L16,	 0, 1, 0, 2850000, 3200000, NULL,      0, 0), 
	RPM_LDO(L17,	 0, 1, 0, 2800000, 2800000, NULL,      0, 0),
	RPM_LDO(L18,	 0, 1, 0, 1100000, 1100000, "8921_s4", 0, 0),
	RPM_LDO(L21,	 0, 1, 0, 1700000, 1700000, "8921_s8", 0, 0),
	RPM_LDO(L22,	 0, 1, 0, 2700000, 2700000, NULL,      0, 0),
